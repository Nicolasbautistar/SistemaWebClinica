<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="GestionarPaciente.aspx.cs" Inherits="SistemaWebClinica1.GestionarPaciente" ClientIDMODE="Static"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentBody" runat="server">
    ...
    <div class="modal" id="imodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id="btnactualizar" data-dismiss="modal" onclick="updateDataAjax()">Actualizar</button>
                </div>
            </div>
        </div>
    </div>
